class OrderForm
  ...
  def save
    ...
    Address.create(order_id: order.id, city: city, house_number: house_number, building_name: building_name,
                   postal_code: postal_code, phone_number: phone_number, prefecture_id: prefecture_id)
  end
end
